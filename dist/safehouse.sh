...
# Embedded Profiles Last Modified (UTC): 2026-05-19T20:34:10Z
...
(allow mach-lookup
    ...
    (global-name-prefix "com.apple.distributed_notifications@")
    ;; Finder drag-and-drop coordination for GUI apps.
    (local-name "com.apple.coredrag")
)
...
safehouse_project_version_embedded="0.10.0"
